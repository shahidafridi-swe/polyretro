    ...
    <div class="text-gray-300">
        <form method="POST" action="/teams" enctype="multipart/form-data" class="max-w-lg mx-auto  p-6 rounded-lg shadow-lg">
            ...
            <div class="flex items-center gap-2">
                <input type="email" id="emailInput" class="flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                <button type="button" onclick="addEmail()" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Add</button>
            </div>

            <ul id="emailList" class="mt-4 space-y-2"></ul>
            <input type="hidden" name="members" id="membersInput">

            <button type="submit" class="w-full mt-6 px-4 py-2 bg-cyan-800 text-white font-bold rounded-lg hover:bg-cyan-900">Create Team</button>
        </form>
    </div>
